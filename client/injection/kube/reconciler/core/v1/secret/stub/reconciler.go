...
import (
	...
	secret "knative.dev/pkg/client/injection/kube/reconciler/core/v1/secret"
...
func newReconciledNormal(namespace, name string) reconciler.Event {
	return reconciler.NewEvent(v1.EventTypeNormal, "SecretReconciled", "Secret reconciled: \"%s/%s\"", namespace, name)
}

// Reconciler implements controller.Reconciler for Secret resources.
type Reconciler struct {
	// TODO: add additional requirements here.
}

// Check that our Reconciler implements Interface
var _ secret.Interface = (*Reconciler)(nil)

// Optionally check that our Reconciler implements Finalizer
//var _ secret.Finalizer = (*Reconciler)(nil)
...
//var _ secret.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ secret.ReadOnlyFinalizer = (*Reconciler)(nil)

// ReconcileKind implements Interface.ReconcileKind.
func (r *Reconciler) ReconcileKind(ctx context.Context, o *v1.Secret) reconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *v1.Secret) reconciler.Event {
//	// TODO: add custom finalization logic here.
//	return nil
//}

// Optionally, use ObserveKind to observe the resource when we are not the leader.
// func (r *Reconciler) ObserveKind(ctx context.Context, o *v1.Secret) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *v1.Secret) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
